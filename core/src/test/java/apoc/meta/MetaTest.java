...
//            System.out.println(toCSV(records));
    ...
    public void testMetaDataOfWithRelConstraints() {
        ...
        expectedResult.add(MapUtil.map("other",List.of(),"count",0L,"existence",false,"index",true,"label","LIKES","right",0L,"type","INTEGER","sample",null,"array",false,"left",0L,"unique",true,"property","score","elementType","relationship","otherLabels",List.of()));
