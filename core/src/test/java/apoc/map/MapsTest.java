...
public class MapsTest {
    ...
    public void testValues() {
        TestUtil.testCall(
                ...
                (r) -> assertEquals(asList("foo", 42L), r.get("value")));
        TestUtil.testCall(
                db,
                "RETURN apoc.map.values({b:42,a:'foo',c:false},['a','b','d'],true) as value",
                (r) -> assertEquals(asList("foo", 42L, null), r.get("value")));
        TestUtil.testCall(
                db,
                "RETURN apoc.map.values({b:42,a:'foo',c:false},null) as value",
                (r) -> assertEquals(emptyList(), r.get("value")));
        TestUtil.testCall(
                db,
                "RETURN apoc.map.values({b:42,a:'foo',c:false},[]) as value",
                (r) -> assertEquals(emptyList(), r.get("value")));
    }
    ...
    public void testGroupBy() {
        TestUtil.testCall(
                ...
                (r) -> assertEquals(map("0", map("id", 0L, "c", 2L), "1", map("id", 1L, "b", false)), r.get("value")));
    }
    ...
    public void testMerge() {
        TestUtil.testCall(
                ...
                (r) -> assertEquals(map("a", 1L, "b", false), r.get("value")));
    }
    ...
    public void testSubMap() {
        TestUtil.testCall(
                ...
                (r) -> assertEquals(map("a", 1L), r.get("value")));
        TestUtil.testCall(
                db,
                "RETURN apoc.map.submap({a:1,b:2},['a','b']) AS value",
                (r) -> assertEquals(map("a", 1L, "b", 2L), r.get("value")));
        TestUtil.testCall(
                db,
                "RETURN apoc.map.submap({a:1,b:1},['c'],[42]) AS value",
                (r) -> assertEquals(map("c", 42L), r.get("value")));
        TestUtil.testCall(
                db,
                "RETURN apoc.map.submap({a:1,b:1},['c'],null,false) AS value",
                (r) -> assertEquals(map("c", null), r.get("value")));
    ...
    public void testMGet() {
        ...
        TestUtil.testCall(
                db,
                "RETURN apoc.map.mget({a:1,b:2},['a','b']) AS value",
                (r) -> assertEquals(asList(1L, 2L), r.get("value")));
        TestUtil.testCall(
                db,
                "RETURN apoc.map.mget({a:1,b:1},['c'],[42]) AS value",
                (r) -> assertEquals(List.of(42L), r.get("value")));
        TestUtil.testCall(
                db,
                "RETURN apoc.map.mget({a:1,b:1},['c'],null,false) AS value",
                (r) -> assertEquals(singletonList(null), r.get("value")));
    ...
    public void testSetEntry() {
        TestUtil.testCall(
                ...
                (r) -> assertEquals(map("a", 2L), r.get("value")));
    }
    ...
    public void testRemoveKey() {
        TestUtil.testCall(
                ...
                (r) -> assertEquals(map("b", 2L), r.get("value")));
    }
    ...
    public void testRemoveKeyRecursively() {
        TestUtil.testCall(
                ...
                (r) -> assertEquals(map("b", 2L, "c", map("b", 4L)), r.get("value")));
    }
    ...
    public void testRemoveKeyRecursivelyIncludingCollectionOfMaps() {
        TestUtil.testCall(
                ...
                (r) -> assertEquals(map("b", 2L, "c", asList(map("b", 4L), map("b", 5L))), r.get("value")));
    }
    ...
    public void testRemoveKeyRecursivelyIncludingCollectionOfStrings() {
        TestUtil.testCall(
                ...
                (r) -> assertEquals(map("b", 2L, "c", asList("a", "b")), r.get("value")));
    }
    ...
    public void testRemoveKeysRecursivelyIncludingCollectionOfMaps() {
        TestUtil.testCall(
                ...
                (r) -> assertEquals(map("c", asList(map("d", 1L), map("d", 3L))), r.get("value")));
    }
    ...
    public void testRemoveKeysRecursivelyIncludingCollectionOfInts() {
        TestUtil.testCall(
                ...
                (r) -> assertEquals(map("c", asList(1L, 2L, 3L)), r.get("value")));
    }
    ...
    public void testUpdateTree() {
        TestUtil.testCall(
                ...
                (r) -> assertEquals(
                        map("id", 1L, "a", 1L, "c", map("id", 2L, "a", 2L), "d", List.of(map("id", 3L, "a", 3L))),
                        r.get("value")));
    }
