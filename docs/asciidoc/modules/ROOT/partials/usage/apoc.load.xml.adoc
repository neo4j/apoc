...
----
WITH "https://raw.githubusercontent.com/neo4j/apoc/{branch}/src/test/resources/xml/books.xml" AS uri
...
[source,cypher,subs=attributes]
----
call apoc.load.xml("https://raw.githubusercontent.com/neo4j/apoc/{branch}/src/test/resources/xml/books.xml")
